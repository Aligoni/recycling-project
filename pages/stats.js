    ...
    return (
        <div className={styles.container}>
            ...
            <div className="text-xl m-10">
                The map below displays the total Municipal Solid Waste (MSW) generated by each country.
                Generally the more waste generated by a country, the more that country should
                spend on recyling.
            </div>
            ...
            <div className="text-xl p-10 bg-white">
                The table provides the distribution of the MSW generated for the major recyclable materials
